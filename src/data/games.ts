...
const GAMES_DOSSIER_PROJECTS: ProjectPageType = {
    ...
    projectDescription: [
        ...
        {
            image: "https://upload.wikimedia.org/wikipedia/commons/c/c5/Openttdlogo.svg",
            header: "OpenTTD",
        ...
        {
            image: "https://upload.wikimedia.org/wikipedia/commons/9/99/0_A.D._logo.svg",
            header: "0 A.D.",
        ...
        {
            image: "https://upload.wikimedia.org/wikipedia/commons/f/f0/Openarena-logo.svg",
            header: "OpenArena",
        ...
        {
            image: "https://upload.wikimedia.org/wikipedia/commons/a/a4/Minetest_logo.svg",
            header: "Luanti",
...
export const DOSSIER: DossierType = {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/3/30/Console-controller_-_game-icons.svg",
    header: "Games",
